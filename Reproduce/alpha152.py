...
def run_formula(dv):    
    alpha152 = dv.add_formula("alpha152","Sma(Ts_Mean(Delay(Sma(Delay(close/Delay(close,9),1),9,1),1),12)-Ts_Mean(Delay(Sma(Delay(close/Delay(close,9),1),9,1),1),26),9,1)", is_quarterly=False, add_data=True)
    return alpha152