...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['BBI','EPS','PE','PS','ACCA','CTOP','MA10RegressCoeff12','AR','BR','ARBR','np_parent_comp_ttm','total_share','bps', 'volume']
...
from Tamplate import alpha14, alpha45, alpha71, alpha152, alpha156, CashRateOfSalesLatest, OperCashFlowPS
